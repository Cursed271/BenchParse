...
<div align="center">
  ...
  <p>
    Found a bug in BenchParse? Report it here so we can fix it! Please provide as much detail as possible.
  </p>
...
1. **Execute the Script**: Use "***python3 BenchParse.py***"
2. **Enter the Path of the CIS Benchmark (When Prompted)**
3. **Specify the output filename (When Prompted)**
